      ...
      child: Scaffold(
          ...
          body: ListView(
            children: [
              ...
              FutureBuilder(
                  future:
                      invoiceDetailsController.getInvoiceDetails(invoiceId: id),
                  builder: (contexts, snapshot) {
                    ...
                    return Obx(() {
                      return invoiceDetailsController.invoiceDetailsList.isEmpty
                          ? Column(
                              children: [
                                SizedBox(
                                  height: 10.h,
                                ...
                                return Padding(
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                          ...
                                          child: Row(
                                            ...
                                            children: [
                                              ElevatedButton.icon(
                                                  ...
                                                  label: Text("Processing", style: GoogleFonts.roboto(color: Color.fromARGB(255, 99, 104, 100), fontSize: 16, fontWeight: FontWeight.w500))),
                                            ],
                                          ),
                                        );
                                      }),
                                      ...
                                      Visibility(
                                        visible: (newData.invoiceData.status ==
                                                    "Pending" ||
                                                newData.invoiceData.status ==
                                                    "Verified")
                                            ? false
