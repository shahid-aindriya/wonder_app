...
class SellerRegistView extends GetView<SellerRegistController> {
  ...
  Widget build(BuildContext context) {
    ...
    final TextEditingController panNumberEditingController =
        TextEditingController();
    final TextEditingController tanNumberEditingController =
        TextEditingController();
                    ...
                    Padding(
                      ...
                      child: Column(
                        children: [
                          ...
                          GetBuilder<SellerRegistController>(
                            ...
                            return Row(
                              children: [
                                ...
                                InkWell(
                                  onTap: () {
                                    controller.showPopup(context, value: true);
                                  },
                                  child: Container(
                                    width: 100,
                                    height: 56,
                          ...
                          GetBuilder<SellerRegistController>(
                            ...
                            return Row(
                              children: [
                                ...
                                InkWell(
                                  onTap: () async {
                                    controller.showPopup(context, value: false);
                                  },
                                  child: Container(
                                    width: 100,
                                    height: 56,
                          ...
                          TextFormField(
                            controller: tanNumberEditingController,
                            enabled: true,
                            style: GoogleFonts.roboto(
                                fontSize: 18,
                                color: Color.fromRGBO(0, 0, 0, 1)),
                        ...
                        onPressed: () {
                          if (controller.panimg == '' ||
                            ...
                            Get.to(PasswordGenerationView(
                              ...
                              tanImg: controller.tanImg ,
                              tanNumber:tanNumberEditingController.text,
                            ));
                          }
                        },
                        child: Text(
